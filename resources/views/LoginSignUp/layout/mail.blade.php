<div>
    ...
    <div style="">
        <button style="width: 150px;height: 40px;margin: 10px 0px;border: none;border-radius: 5px;background-color: #0d6efd;">
            <a style="display: block;width: 100%;color: #fff !important;text-decoration: none;font-size: 13.5px;" href="{{ route('login.confirmuser', ['token'=>$token , 'cccd' => $cccd ]) }}">Kích hoạt tài khoản</a>
        </button>
    </div>
</div>
